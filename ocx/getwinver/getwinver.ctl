VERSION 5.00
Begin VB.UserControl GetWinVer 
   CanGetFocus     =   0   'False
   ClientHeight    =   660
   ClientLeft      =   0
   ClientTop       =   0
...
'기본 속성 값:
Const m_def_IsAboveNT = 0
'속성 변수:
Dim m_IsAboveNT As Boolean
...
Public Function GetWindows() As String
    ...
    Select Case tVersionInfo.dwMajorVersion
        ...
        Case 5: 'WINNT4 이상
            ...
            End Select
        Case 6:
            m_IsAboveNT = True 'Bugfix:issue6
    ...
    GetWindows = sOSName & vbCrLf & sFullVersion & vbCrLf & sCoreNumbers
End Function

'경고! 주석으로 되어 있는 다음 줄은 제거하거나 수정하지 마십시오!
'MemberInfo=0,1,2,0
Public Property Get IsAboveNT() As Boolean
Attribute IsAboveNT.VB_Description = "Windows NT 커널 여부를 반환합니다."
Attribute IsAboveNT.VB_MemberFlags = "400"
    IsAboveNT = m_IsAboveNT
End Property

Public Property Let IsAboveNT(ByVal New_IsAboveNT As Boolean)
...
Private Sub UserControl_InitProperties()
    m_IsAboveNT = m_def_IsAboveNT
End Sub

'저장소에서 속성값을 로드합니다.
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)

    m_IsAboveNT = PropBag.ReadProperty("IsAboveNT", m_def_IsAboveNT)
End Sub

'속성값을 저장소에 기록합니다.
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)

    Call PropBag.WriteProperty("IsAboveNT", m_IsAboveNT, m_def_IsAboveNT)
End Sub
